    ...
    <SKILLS id="skills">
      ...
      <div className="skills-row">
        <Ticker duration={60} direction={1} className="container">
          <div className="skills-card">
            <img
              src="https://bhavatah.com/images/zoho-CRM.png"
              className="skills-card-img"
            />
            <p className="skills-card-name">Zoho CRM</p>
          </div>
          <div className="skills-card">
            <img src="https://bhavatah.com/images/catalyst-logo.png" className="skills-card-img" />
            <p className="skills-card-name">Zoho Catalyst</p>
          </div>
          <div className="skills-card">
            <img src="https://bhavatah.com/images/Creator-1024.png" className="skills-card-img" />
            <p className="skills-card-name">Zoho Creator</p>
          </div>
          <div className="skills-card">
            <img src="https://bhavatah.com/images/sign-512.png" className="skills-card-img" />
            <p className="skills-card-name">Zoho Sign</p>
          </div>
          <div className="skills-card">
            <img src="https://bhavatah.com/images/flow.png" className="skills-card-img" />
            <p className="skills-card-name">Zoho Flow</p>
          </div>
          <div className="skills-card">
            <img src="https://bhavatah.com/images/Zoho%20Writer.png" className="skills-card-img" />
            <p className="skills-card-name">Zoho Write</p>
          </div>
           <div className="skills-card">
            <img src="https://bhavatah.com/images/zoho%20sheet.png" className="skills-card-img" />
            <p className="skills-card-name">Zoho Sheet</p>
          </div>
           <div className="skills-card">
            <img src="https://bhavatah.com/images/zoho-pagesense.webp" className="skills-card-img" />
            <p className="skills-card-name">Zoho PageSense</p>
          </div>
           <div className="skills-card">
            <img src="https://bhavatah.com/images/Zoho%20Analytics.png" className="skills-card-img" />
            <p className="skills-card-name">Zoho Analytics</p>
          </div>
           <div className="skills-card">
            <img src="https://bhavatah.com/images/Forms-1024.png" className="skills-card-img" />
      ...
      <div className="skills-row">
        <Ticker duration={60} direction={-1} className="container">
          ...
          <div className="skills-card">
            <img src="https://global-uploads.webflow.com/5ebea55066f36f531dec5b32/62bf68f37b012285a9f7ac59_83326223-3491-4a4b-8c35-72a786e597d5.png" className="skills-card-img" />
      ...
      <div className="skills-row">
        ...
        <Ticker duration={60} direction={1}>
          <div className="skills-card">
            ...
            <p className="skills-card-name">Vercal</p>
          </div>
          <div className="skills-card">
